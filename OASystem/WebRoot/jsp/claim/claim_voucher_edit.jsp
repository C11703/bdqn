		...
		<div class="pages">
			...
			<input type="hidden" id="rowNumber" name="rowNumber" value="<s:property value="rowNumber"/>"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					<tr>
						<td>*填报人：</td>
						<td><s:property value="#session.employeename"/></td>
						<td>*填报时间：</td>
						<td>2013-8-17 8：30</td>
					</tr>
					<tr>
						<td>*总金额：￥</td>
						<td><input type="text" id="totalAccount" name="claimVoucherDetail.bizClaimVoucher.totalAccount" value=""/></td>
						<!-- claimVoucher.totalAccount -->
						<td>*状态：</td>
						<td><input type="text" id="status" name="claimVoucherDetail.bizClaimVoucher.status" value="新创建"
				...
				<table>
					<tr>
						<td>*事由：</td>
						<td colspan="3"><textarea rows="5" cols="66" name="claimVoucherDetail.event"
										id="event"></textarea>
						</td>
					</tr>
